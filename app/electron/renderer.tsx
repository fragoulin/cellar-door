...
import { Router } from 'app/src/components/router/router-component'
import * as CellarStore from 'app/src/redux/store'
import { Store } from '@reduxjs/toolkit'
import { I18nextProvider } from 'react-i18next'
import * as i18nConfig from 'app/src/localization/i18next.config'
import { i18n as I18n } from 'i18next'
import { currentLocaleSet } from 'app/src/redux/modules/cellar'
